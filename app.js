...
let weaponsArray = [rope, knife,  candlestick, dumbbell, poison, axe, trophy, pistol];
...
function guess(){
  ...
  if(guessedSuspect === mystery.suspect.name && guessedWeapon === mystery.weapon.name && guessedRoom === mystery.room.name){
    ...
    alert(mystery.suspect.name + " killed in " + mystery.room.name + " with " + mystery.weapon.name);
  }
